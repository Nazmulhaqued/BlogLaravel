...
<head>
   ...
   <link href="{{asset('public/admin_asset')}}/assetsbootstrap/css/bootstrap.min.css" rel="stylesheet" />
   <link href="{{asset('public/admin_asset')}}/assetsbootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" />
   <link href="{{asset('public/admin_asset')}}/assetsfont-awesome/css/font-awesome.css" rel="stylesheet" />
    ...
    <div class="login-wrap">
        ...
        <div class="metro double-size green">
            <div class="input-append lock-input">
               <input type="text" name="admin_email" class="" placeholder="Username">
            </div>
        </div>
